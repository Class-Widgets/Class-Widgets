...
class PluginDetailPage(MessageBoxBase):  # 插件详情页面
    ...
    def init_ui(self):
        ...
        uic.loadUi(CW_HOME / 'view/pp/plugin_detail.ui', self.temp_widget)
...
class PluginPlaza(MSFluentWindow):
    ...
    def __init__(self):
        ...
        try:
            self.homeInterface = uic.loadUi(CW_HOME / 'view/pp/home.ui')  # 首页
            self.homeInterface.setObjectName("homeInterface")
            self.latestsInterface = uic.loadUi(CW_HOME / 'view/pp/latests.ui')  # 最新更新
            self.latestsInterface.setObjectName("latestInterface")
            self.settingsInterface = uic.loadUi(CW_HOME / 'view/pp/settings.ui')  # 设置
            self.settingsInterface.setObjectName("settingsInterface")
            self.searchInterface = uic.loadUi(CW_HOME / 'view/pp/search.ui')  # 搜索
